...
public class MaqueeTextView1 extends TextView implements Runnable {
    private static final String TAG = "MaqueeTextView1";
    // 设置跑马灯重复的次数，次数
    ...
    // 构造方法
    public MaqueeTextView1(Context context, AttributeSet attrs) {
        super(context, attrs);
