...
public class SplashActivity extends Activity implements SplashADListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.adtx_activity_splash);
  ...
  public void onNoAD(AdError error) {
    ...
    handler.postDelayed(new Runnable() {
      @Override
      public void run() {
        SplashActivity.this.startActivity(new Intent(SplashActivity.this, BannerMainActivity.class));
  ...
  private void next() {
    if (canJump) {
      this.startActivity(new Intent(this, BannerMainActivity.class));
      this.finish();
    } else {
      canJump = true;
    }
