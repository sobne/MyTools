...
public class ContentADActivity extends Activity implements ContentAD.ContentADListener {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    setContentView(R.layout.adtx_activity_gdtcontentad);
  ...
  public void loadAD() {
    ...
    if (contentAD == null) {
      this.contentAD = new ContentAD(this, Constants.APPID, Constants.ContentADPosID, this);
    }
    int pageNumber = 1;
    int channel = 98;
  ...
  public class MyAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
      ...
      if (convertView == null || convertView.getTag() == null) {
        ...
        if (contentAdData.getType() == ContentAdType.AD) {
          convertView = this.mInflater.inflate(R.layout.adtx_item_ad, null, false);
          ...
          convertView = this.mInflater.inflate(R.layout.adtx_contentlistitem, null, false);
